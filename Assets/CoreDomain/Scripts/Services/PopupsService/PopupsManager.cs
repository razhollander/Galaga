...
namespace CoreDomain
{
    ...
    //     {
    //         _client.Broadcaster.Add<BaseGameState<IGameStateEnterData>>(OnGameStateChanged);
    //     }
    //
    //     private void RemoveListeners()
    //     {
    //         _client.Broadcaster.Remove<BaseGameState<IGameStateEnterData>>(OnGameStateChanged);
    //     }
    //
